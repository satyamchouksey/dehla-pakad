...
export function VoiceChat({ compact = false }: VoiceChatProps) {
  const { isInVoice, isMuted, isVideoOn, peers, micError, joinVoice, leaveVoice, toggleMute, toggleVideo } = useVoiceChatContext();
      ...
      <div className="flex items-center gap-1.5">
        {!isInVoice ? (
          ...
          <div className="flex items-center gap-1">
            ...
            >
              {isVideoOn ? <VideoIcon size={12} /> : <VideoOffIcon size={12} />}
            </button>
      ...
      {!isInVoice ? (
        ...
        >
          ...
          <div className="flex gap-2">
            ...
            >
              {isVideoOn ? <VideoIcon size={14} /> : <VideoOffIcon size={14} />}
...
function VideoOffIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M10.66 5H14a2 2 0 0 1 2 2v2.5l5.248-3.062A.5.5 0 0 1 22 6.87v10.196" />
